...
- a Go service that can:
  ...
  - inspect shell-scoped git working trees in a unified review overlay above the control sidebar with scroll-batched file loading and without resizing the workspace canvas
