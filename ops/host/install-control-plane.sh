...
FASCINATE_DEFAULT_USER_MAX_CPU=$(quote_env_value "${FASCINATE_DEFAULT_USER_MAX_CPU:-2}")
FASCINATE_DEFAULT_USER_MAX_RAM=$(quote_env_value "${FASCINATE_DEFAULT_USER_MAX_RAM:-8GiB}")
FASCINATE_DEFAULT_USER_MAX_DISK=$(quote_env_value "${FASCINATE_DEFAULT_USER_MAX_DISK:-50GiB}")
FASCINATE_DEFAULT_USER_MAX_MACHINES=$(quote_env_value "${FASCINATE_DEFAULT_USER_MAX_MACHINES:-25}")
FASCINATE_DEFAULT_USER_MAX_SNAPSHOTS=$(quote_env_value "${FASCINATE_DEFAULT_USER_MAX_SNAPSHOTS:-5}")
FASCINATE_MAX_MACHINES_PER_USER=$(quote_env_value "${FASCINATE_MAX_MACHINES_PER_USER:-25}")
