...
STRESS_MAX_CPU="${FASCINATE_STRESS_MAX_CPU:-5}"
STRESS_MAX_MEMORY_BYTES="${FASCINATE_STRESS_MAX_MEMORY_BYTES:-10737418240}"
STRESS_MAX_DISK_BYTES="${FASCINATE_STRESS_MAX_DISK_BYTES:-85899345920}"
STRESS_MAX_MACHINE_COUNT="${FASCINATE_STRESS_MAX_MACHINE_COUNT:-5}"
